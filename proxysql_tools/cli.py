...
def register(cfg):
    ...
    try:
        ...
        proxysql = ProxySQL(host=cfg.get('proxysql', 'host'),
                            port=cfg.get('proxysql', 'admin_port'),
                            user=cfg.get('proxysql', 'admin_username'),
                            password=cfg.get('proxysql', 'admin_password'))
